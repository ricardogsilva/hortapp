...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'WorkSession.garden'
        db.delete_column('horta_worksession', 'garden_id')
    ...
    def backwards(self, orm):
        # Adding field 'WorkSession.garden'
        db.add_column('horta_worksession', 'garden',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['horta.Garden']),
                      keep_default=False)
