...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Plantation.created'
        db.delete_column('horta_plantation', 'created')

        # Deleting field 'Plantation.modified'
        db.delete_column('horta_plantation', 'modified')

        # Deleting field 'Plantation.id'
        db.delete_column('horta_plantation', 'id')

        # Adding field 'Plantation.item_ptr'
        db.add_column('horta_plantation', 'item_ptr',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Plantation.created'
        raise RuntimeError("Cannot reverse this migration. 'Plantation.created' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Plantation.modified'
        raise RuntimeError("Cannot reverse this migration. 'Plantation.modified' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Plantation.id'
        raise RuntimeError("Cannot reverse this migration. 'Plantation.id' and its values cannot be restored.")
        # Deleting field 'Plantation.item_ptr'
        db.delete_column('horta_plantation', 'item_ptr_id')
